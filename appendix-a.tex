...
%fix dq = ILam n. ILam m. CLam. lam l1 . lam l2. ILam j.
%case l2 of
...
\inferrule[S-Impl]{\Psi ; \Theta ; \Delta,\Phi_2 \vdash \tau_1 \subty \tau_2 : \star\\ \Theta;\Delta \vDash \Phi_2 \to \Phi_1}{\Psi ; \Theta ; \Delta \vdash \Phi_1 \implies \tau_1 \subty \Phi_2 \implies \tau_2 : \star}
...
\Psi ; \Theta ; \Delta, I \geq 1; \Omega ; \Gamma_2, h : \tau, t : L^{I-1} \tau \vdash e_2 : \tau'\\
}
...
\inferrule[AS-Impl]{\Psi ; \Theta ; \Delta,\Phi_2 \vdash \tau_1 \subtynf \tau_2 : \star \gens \Phi}{\Psi ; \Theta ; \Delta \vdash \Phi_1 \implies \tau_1 \subtynf \Phi_2 \implies \tau_2 : \star \gens (\Phi_2 \to \Phi) \wedge (\Phi_2 \to \Phi_1)}
...
\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash \texttt{ret } e \checks \M \,(I,\vec{p}) \, \tau \gens \Phi, \Gamma'
}
...
\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash \texttt{tick}[I|\vec{p}] \infers \M \, (I,\vec{p})\, 1 \gens \Phi_1 \wedge \Phi_2,\Gamma
}
...
\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash \texttt{store}[K|\vec{w}](e) \checks \M \, (I,\vec{q}) \, ([J | \vec{p}] \, \tau) \gens \Phi, \Gamma'
}
...
\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash \texttt{store}[J](e) \checks \M \, (K,\vec{p}) \, ([I] \, \tau) \gens \Phi, \Gamma'
}

\inferrule[AT-ReleaseConst]
{
\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash e_1 \infers [J] \tau_1 \gens \Phi_1,\Gamma_1\\
\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1, x : \tau_1 \vdash e_2 \checks \M \, (I,\vec{p} + \texttt{const}(J)) \, \tau_2 \gens \Phi_2, \Gamma_2
}{
\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash \texttt{release } x = e_1 \texttt{ in }e_2 \checks \M \, (I,\vec{p}) \, \tau_2 \gens \Phi_1 \wedge \Phi_2, \Gamma_2 \setminus \{x\}
}

\inferrule[AT-Shift]
{
\Psi ; \Theta ; \Delta  ; \Omega ; \Gamma \vdash e \checks \M \, (I - 1,\lhd \vec{q}) \, \tau \gens \Phi, \Gamma'
}{
\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash \texttt{shift}(e) \checks \M \, (I,\vec{q}) \, \tau \gens (I \geq 1) \wedge \Phi, \Gamma'
}
...
\begin{theorem}[Raw Soundness of Type Checking/Inference]
...
\begin{theorem}[Assumption Precomposition for Sort Assignment]
...
\begin{theorem}[Assumption Precomposition for Constraint Well-Formedness]
...
\begin{theorem}[Assumption Precomposition for Kind Assignment]
...
\begin{theorem}[Assumption Precomposition for Subtyping]
...
\section{Proofs}
\input{proofs/raw-idx-idx-subst}

\input{proofs/raw-constr-idx-subst}
