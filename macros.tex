...
\newcommand{\disc}[2]{\ensuremath{\texttt{spend}_{#1} \; #2}}
\newcommand{\wait}[2]{\ensuremath{\texttt{create}_{#1} \; #2}}
...
\newcommand{\jgivengoalThreeExists}[5]{
  %\vspace{0.5em}

  {
    ...
    \noindent $\blacktriangleright$ \textbf{There exist} #2 \textbf{such that:}
...
\newcommand{\jgivengoalFour}[5]{
...

  {
    ...
    \noindent $\blacktriangleright$ \textbf{Goal 4:}
