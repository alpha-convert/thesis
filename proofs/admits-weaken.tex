...
\begin{itemize}
  ...
  \item[(AT-Match)] Suppose 
   ...
   because of $\Psi ; \Theta ; \Delta \vdash \Gamma_1' \wknto \Gamma' \setminus \Gamma$,  $\Psi ; \Theta ; \Delta \vdash \Gamma_2' \wknto \Gamma_1' \setminus \Gamma_1$, and $\Psi ; \Theta ; \Delta, I \geq 1 \vdash \Gamma_3' \wknto \Gamma_1' \setminus \Gamma_1$, making heavy use of Theorem~\ref{thm:ctx-sub-subset2}.
   Finally, we have   
