\jtheorem{Proof of \autoref{thm:subtynf-refl}}{
  ...
  \jcase{1}{K-Var}{Immediate by \autoref{thm:subtyne-refl}}
  
  \jcase{2}{K-Unit}{Immediate by \autoref{thm:subtyne-refl}}
  ...
  \jcase{11}{K-List}{
    ...
    \caseText{By \autoref{thm:sound-compl} applied to (4), we may re-establish the presupposition for (7)}
  ...
  \jcase{12}{K-Conj}{
    ...
    \caseText{By \autoref{thm:constr-compl} on (4), we may re-establish the presupposition for (7)}
  ...
  \jcase{12}{K-Impl}{
    \jgivengoal{
      ...
      \caseFact{3} $\Psi ; \Theta ; \Delta, \Phi' \vdash \tau : \star$
    ...
    \caseFact{5} $\Psi ; \Theta ; \Delta, \Phi' \pvdash \tau \subtynf \tau : \star \gens \Phi$
    
    \caseFact{6} $\Theta ; \Delta, \Phi' \vDash \Phi$
    
    \caseText{By AS-Impl on (5)}
    
    \caseFact{7} $\Psi ; \Theta ; \Delta \vdash \Phi' \implies \tau \subtynf \Phi' \implies \tau : \star \gens (\Phi' \to \Phi) \wedge (\Phi' \to \Phi')$
    
    \caseText{By \autoref{thm:constr-compl} on (4), we may re-establish the presupposition for (7)}
    
    \caseFact{8} $\Psi ; \Theta ; \Delta \pvdash \Phi' \implies \tau \subtynf \Phi' \implies \tau : \star \gens (\Phi' \to \Phi) \wedge (\Phi' \to \Phi')$
  ...
  \jcase{13}{K-Monad}{
    ...
    \caseText{By AS-Monad on (6), followed by \autoref{thm:sound-compl} on (4) and (5) to establish the presuppositions}
  ...
  \jcase{14}{K-Pot}{
    ...
    \caseText{By AS-Pot on (6), followed by \autoref{thm:sound-compl} on (4) and (5) to establish the presuppositions}
  ...
  \jcase{15}{K-ConstPot}{
    ...
    \caseText{By AS-ConstPot on (5) followed by \autoref{thm:sort-compl} on (4) to re-establish the presupposition}
  ...
  \jcase{17}{K-FamApp}{Immediate by \autoref{thm:subtyne-refl}}
...
\iffalse
  ...
  \item[(K-FamApp)] Done by \autoref{thm:subtyne-refl}
\fi