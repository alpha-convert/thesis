...
\jcase{28}{T-Ret}{
 ...
 \jcase{34}{T-ReleaseConst}{
  \jgivengoalThreeExists{
    \caseFact{1} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1,\Gamma_2 \vdash \texttt{release } x = e_1 \texttt{ in }e_2 : \M \, (I,\vec{p}) \, \tau_2$

    \caseFact{2} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1 \vdash e_1 : [J] \tau_1$

    \caseFact{3} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_2, x : \tau \vdash e_2 : \M \, \phi(I,\vec{p} + \texttt{const}(J)) \, \tau_2$
    ...
    $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1,\Gamma_2 \pvdash e' \checks  \M \, (I,\vec{p}) \, \tau_2,\Gamma'$  
  }
  ...
  \caseFact{6} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1 \vdash e_1' \infers [J] \tau_1 \gens \Phi_1,\Gamma_1'$
  ...
  \caseFact{10} $\Psi ; \Theta ; \Delta ; \Omega; \Gamma_1,\Gamma_2 \vdash e_1'' \infers [J] \tau_1 \gens \Phi_1',\Gamma_1''$
  ...
  \caseFact{13} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_2, x : \tau \vdash e_2' \checks \M \, (I,\vec{p} + \texttt{const}(J)) \, \tau_2 \gens \Phi_2,\Gamma_2'$

  \caseText{By \autoref{thm:ctx-sub-subset-2} and \autoref{thm:admits-weaken} on (10) and (13), there are $e_2''$, $\Phi_2'$, $\Gamma_2''$ such that}

  \caseFact{14} $|e_2''| = |e_2'|$

  \caseFact{15} $\Theta ; \Delta \vDash \Phi_2'$

  \caseFact{16} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1'', x: \tau \vdash e_2'' \checks  \M \, (I,\vec{p} + \texttt{const}(J)) \, \tau_2 \gens \Phi_2',\Gamma_2''$

  \caseText{Goals follow by AT-ReleaseConst on (10) and (16)}

 }

 \jcase{35}{T-Shift}{
  \jgivengoalThreeExists{
    \caseFact{1} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash \texttt{shift}(e) : \M \, (I,\vec{p}) \, \tau$

    \caseFact{2} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash e : \M \, (I - 1,\lhd \vec{p}) \, \tau$

    \caseFact{3} $\Theta ; \Delta \vDash I \geq 1$
    ...
    $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \pvdash e' \checks  \M \, (I,\vec{p}) \, \tau,\Gamma'$  
  }

  \caseText{By IH on (2), there are $e'$, $\Phi$, $\Gamma'$ such that}o

  \caseFact{4} $|e'| = e$

  \caseFact{5} $\Theta ; \Delta \vDash \Phi$

  \caseFact{6} $\Psi  ; \Theta ; \Delta ; \Omega; \Gamma \vdash e' \checks \M \, (I-1,\lhd \vec{p}) \, \tau \gens \Phi,\Gamma'$

  \caseText{Goals follow by AT-Shift on (6)}

 }

 \jcase{36}{T-CImpI}{
  \jgivengoalThreeExists{
    \caseFact{1} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash \Lambda .e : (\Phi' \Rightarrow \tau)$

    \caseFact{2} $\Psi ; \Theta ; \Delta,\Phi' ; \Omega ; \Gamma \vdash e : \tau$
  }{
    $e'$, $\Phi'$,$\Gamma'$  
  }{
    $|e'| = \Lambda. e$
    ...
    $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \pvdash e' \checks (\Phi' \Rightarrow \tau) ,\Gamma'$  
  }
  ...
  \caseFact{5} $\Psi ; \Theta ; \Delta,\Phi'; \Omega ; \Gamma \vdash e' \checks \tau \gens \Phi,\Gamma'$

  \caseText{Goals follow by AT-CImpI on (5)}
 ...
 \jcase{37}{T-CImpE}{
  \jgivengoalThreeExists{
    ...
    \caseFact{2} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash e : \Phi' \Rightarrow \tau$

    \caseFact{3} $\Theta ; \Delta \vDash \Phi'$
  }{
    $e'$, $\Phi'$,$\Gamma'$  
  }{
    $|e'| = e \, \{\}$
    ...
    $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \pvdash e' \infers \tau ,\Gamma'$  
  }
  ...
  \caseFact{6} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash e' \infers \tau \gens \Phi,\Gamma'$

  \caseText{Goals follow by AT-CImpE on (6)}

 }

 \jcase{38}{T-CAndI}{
  \jgivengoalThreeExists{
    \caseFact{1} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash <e> : \Phi' \amp \tau$
    ...
    $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \pvdash e' \checks \Phi' \amp \tau ,\Gamma'$  
  }
  ...
  \caseFact{6} $\Psi  ; \Theta ; \Delta ; \Omega ; \Gamma \vdash e' \checks \tau \gens \Phi,\Gamma'$.

  \caseText{Goals follow by AT-CAndI on (6)}

 }

 \jcase{39}{T=CAndE}{
  \jgivengoalThreeExists{
    \caseFact{1} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1,\Gamma_2 \vdash \texttt{clet } x = e_1 \texttt{ in } e_2 : \tau'$

    \caseFact{2} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1 \vdash e_1 : \Phi' \amp \tau$

    \caseFact{3} $\Psi ; \Theta ; \Delta, \Phi' ; \Omega ; \Gamma_2, x : \tau \vdash e_2 : \tau'$
  }{
    $e'$, $\Phi'$,$\Gamma'$  
  }{
    $|e'| = \texttt{clet } x = e_1 \texttt{ in } e_2$
  }{
    $\Theta ; \Delta \vDash \Phi'$  
  }{
    $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1,\Gamma_2 \pvdash e' \checks \tau' ,\Gamma'$  
  }
  ...
  \caseFact{6} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1 \vdash e_1' \infers \Phi' \amp \tau \gens \Phi_1,\Gamma_1'$
  ...
  \caseFact{10} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma_1,\Gamma_2 \vdash e_1'' \infers \Phi' \amp \tau \gens \Phi_1',\Gamma_1''$

  \caseText{By IH on (3), there are $e_2'$, $\Phi_2$, $\Gamma_2'$ such that}

  \caseFact{11} $|e_2'| = e_2$

  \caseFact{12} $\Theta ; \Delta,\Phi' \vDash \Phi_2$

  \caseFact{13} $\Psi ; \Theta ; \Delta,\Phi' ; \Omega ; \Gamma_2,x : \tau \vdash e_2' \checks \tau' \gens \Phi_2,\Gamma_2'$

  \caseText{By \autoref{thm:ctx-sub-subset-2} and \autoref{thm:ctx-sub-wkn} on (10)}

  \caseFact{14} $\Psi ; \Theta ; \Delta,\Phi' \vdash \Gamma_1'',x : \tau \wknto \Gamma_2,x : \tau$

  \caseText{So, by \autoref{thm:admits-weaken} on (14) and (14) there are $e_2''$, $\Phi_2'$, $\Gamma_2''$ such that}

  \caseFact{15} $|e_2''| = |e_2'|$

  \caseFact{16} $\Theta ; \Delta, \Phi' \vDash \Phi_2'$

  \caseFact{17} $\Psi ; \Theta ; \Delta, \Phi' ; \Omega ;\Gamma_1'',x:\tau \vdash e_2'' \checks \tau' \gens \Phi_2',\Gamma_2''$

  \caseText{Goals follow by AT-CAndE on (10) and (17)}
 }
 ...
 \jcase{40}{T-Sub}{
  \jgivengoalThreeExists{
    ...
    \caseFact{3} $\Psi;\Theta;\Delta \vdash \tau' \subty \tau : \star$. 
  ...
  \caseText{By IH on (2), there are $e',\Phi_1,\Gamma'$ so that}

  \caseFact{4} $|e'| = e$

  \caseFact{5} $\Theta ; \Delta \vDash \Phi_1$

  \caseFact{6} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash e' \infers \tau' \gens \Phi_1,\Gamma'$

  \caseText{By \autoref{thm:subty-compl} on (3), there is $\Phi_2$ such that}

  \caseFact{7} $\Theta ; \Delta \vDash \Phi_2$

  \caseFact{8} $\Psi ; \Theta ; \Delta \vdash \tau' \subty \tau : \star \gens \Phi_2$

  \caseText{Goals follow by AT-Sub on (6) and (8)}
 ...
 \jcase{41}{T-Weaken}{
  \jgivengoalThreeExists{
    ...
    \caseFact{3} $\Theta ; \Delta \vdash \Omega' \bdby \Omega$

    \caseFact{4} $\Theta ; \Delta \vdash \Gamma' \bdby \Gamma$
  }{
    $e'$, $\Phi'$,$\Gamma'$  
  }{
    $|e'| = e$
  ...
  \caseFact{7} $\Psi ; \Theta ; \Delta ; \Omega ; \Gamma \vdash e : \tau \gens \Phi, \Gamma''$

  \caseText{Goals follow by \autoref{thm:admits-weaken} on (7)}
