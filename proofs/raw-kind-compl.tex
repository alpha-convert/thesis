\jtheorem{Proof of Theorem~\ref{thm:raw-kind-compl}}{
  \jgivengoal{
  ...
  \jcase{10}{K-List}{
    ...
    \caseText{By Theorem~\ref{thm:raw-sort-compl} on (2)}
  ...
  \jcase{11}{K-Conj}{
    ...
    \caseText{By Theorem~\ref{thm:raw-constr-compl} on (2)}
  ...
  \jcase{13}{K-Monad}{
    ...
    \caseText{By Theorem~\ref{thm:raw-sort-compl} on (2) and (3)}
  ...
  \jcase{17}{K-FamApp}{
    ...
    \caseText{By Theorem~\ref{thm:raw-sort-compl} on (3)}
