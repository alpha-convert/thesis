\jtheorem{Proof of \autoref{thm:raw-subtynf-sound}}{
  ...
  \jcase{13}{AS-Impl}{
   \jgivengoal{
     \caseFact{1} $\Psi ; \Theta ; \Delta \vdash \Phi_1 \implies \tau_1 \subtynf \Phi_2 \implies \tau_2 : \star \gens \Phi \wedge (\Phi_2 \to \Phi_1)$
     
     \caseFact{2} $\Theta ; \Delta \vDash \Phi \wedge (\Phi_2 \to \Phi_1)$
   ...
   \caseFact{5} $\Theta ; \Delta \vDash \Phi_2 \to \Phi_1$
