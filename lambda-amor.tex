...
%\red{When presenting the next stuff, do I want to introduce the features in parallel (like I currently do), or build up the type system by layering things on one by one? Make sure you mentionthe explicit choice you've made here.}
